...
import os
modelPath='C:/Users/sabik/PycharmProjects/DeepLearningBasics/AdvancedModel1.h5'
...
labels=['','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',]
path, dirs, files = next(os.walk("C:/Users/sabik/PycharmProjects/DeepLearningBasics/TrainTestImages/Test/7"))
file_count = len(files)
print(file_count)
for i in range(1,100,1):
    filename = imagepath + '7/7 ('+str(i)+').jpg'
    # type(filename)
