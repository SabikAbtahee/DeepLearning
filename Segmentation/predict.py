...
variable = ['1', '0', '3', '2', '4', '6', 'pi', 'A', 'a', 'c', 'b', 'd', 'f', 'i', 'h', 'k', 'm', 'o', 'n', 'p', 's',
            't', 'y', 'x', '(', ')']
brules = {}
...
if __name__ == '__main__':
    ...
    image_folder_path='C:\\Users\\sabik\\PycharmProjects\\DeepLearningBasics\\TestIMages\\'
    ...
    #     isWindows_flag = True
    # if isWindows_flag:
    image_paths = glob(image_folder_path + '*.jpg')
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "C:\\Users\\sabik\\PycharmProjects\\DeepLearningBasics\\Code\\Segmentation\\model\\model.ckpt")
